...
import 'package:flutter_barcode_scanner/flutter_barcode_scanner.dart';
  ...
  class _WalletState extends State<Wallet> {
    ...
    List<dynamic> _services = [
      ...
      // Neumorphism design
      ['Visa', Iconsax.card, Color(0xFFf0f0f0), Color(0xFFd9d9d9)],
      // Neumorphism design
            ...
            slivers: [
              SliverAppBar(
                ...
                actions: [
                  IconButton(
                    icon: Icon(
                        Iconsax.notification, color: Colors.grey.shade700),
                    onPressed: () {},
                  ),
                  IconButton(
    ...
    Widget _buildServiceButton(List<dynamic> service) {
      return FadeInDown(
          ...
          child: Column(
            children: [
              Container(
                ...
                height: 60,
                child: Center(
                  child: Icon(service[1], color: Colors.white, size: 25),
                ),
              ),
              SizedBox(height: 10),
              Text(service[0],
