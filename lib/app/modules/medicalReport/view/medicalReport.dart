              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    Button(
                      on_pressed: () async{
                        var data=await FirebaseFirestore.instance.collection('emergencies').doc(homepageStaffController.patientId).get();
                        if(data['ambulanceStatus']=='assigned'){
                          await FirebaseFirestore.instance.collection('emergencies').doc(homepageStaffController.patientId).update({
                            'medicalReport':{
